...
dict={"c1":1,"c2":50,"c3":100}
class1name=train1['species'][dict[class1]]
class2name=train2['species'][dict[class2]]
...
for i in range(epochs):
    for count in range(0, len(training)):
            w0,w1, w2 = Training.training(training[x1][count], training[x2][count], training['species'][count],w0, w1, w2, L,bias)
    cnt = 0
